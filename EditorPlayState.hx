...
class EditorPlayState extends MusicBeatState
{
	...
	public static var yoooooooAverageEngineFunny:String = '0.1.0'; //used for didcsord@!@!!@#12
	...
	override function create()
	{
		...
		scoreTxt = new FlxText(50, FlxG.height - 50, FlxG.width, "Hits: 0 | Misses: 0", 20);
		scoreTxt.setFormat(Paths.font("veeceearr.ttf"), 20, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		beatTxt.setFormat(Paths.font("veeceearr.ttf"), 20, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		beatTxt.scrollFactor.set();
		beatTxt.borderSize = 1.25;
		add(beatTxt);

		stepTxt = new FlxText(10, 640, FlxG.width, "Step: 0", 20);
		stepTxt.setFormat(Paths.font("veeceearr.ttf"), 20, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		stepTxt.scrollFactor.set();
		stepTxt.borderSize = 1.25;
		add(stepTxt);

        var swagWatermark = new FlxText(4, scoreTxt.y + 5, 0,
		PlayState.SONG.song
		+ " "
		+ " - Current FPS: " + ClientPrefs.framerate //the
		+ " - Average Engine Chart Editor V" + yoooooooAverageEngineFunny, 16);
		swagWatermark.setFormat(Paths.font("veeceearr.ttf"), 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		swagWatermark.scrollFactor.set();
		add(swagWatermark);

		var tipText:FlxText = new FlxText(10, FlxG.height - 24, 0, 'Press ESC to Go Back to Chart Editor', 16);
		tipText.setFormat(Paths.font("veeceearr.ttf"), 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
