 ...
 * "WHATS A MAINFREEPLAYSTATE AND WHY ISNT IT USED"
 * i dont feel like doing this so
 * to put it short, there was gonna be a seperate freeplaystate for main songs, and for mods, in modsfreeplaystate (WHICH YOU ARE VIEWINGGGGGG)
 * so yeah.
 * BYE
 * -average
**/
...
{
	var songs:Array<CumSongMetadata> = [];
	...
	{
		songs.push(new CumSongMetadata(songName, weekNum, songCharacter, color));
	}
